...
export const authAPI = {
    ...
    recowerPassword(password: string, resetPasswordToken: string) {
        return instance.post<{ password: string, resetPasswordToken: string }, AxiosResponse<ResponseType<{ info: string }>>>('2.0/auth/set-new-password', {
            password,
            resetPasswordToken
        })
    }
